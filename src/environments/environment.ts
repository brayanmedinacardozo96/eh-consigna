...
export const environment = {
  ...
  /*
    ...
    apiBackend: 'https://enlinea.electrohuila.com.co/eh-consigna-backends/public/api',
    urlFiles: 'https://enlinea.electrohuila.com.co/eh-consigna-backends/',
    urlPublicFiles: 'https://enlinea.electrohuila.com.co/eh-consigna-backends/public/',
